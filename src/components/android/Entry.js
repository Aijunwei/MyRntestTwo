...
export default class Interface extends Component{
	...
	render(){
		...
		const {actions,statement,city}=this.props;
   		 return (
   		 	<TabNavigator
   		 		tabBarStyle={{height: 90,overflow: 'hidden'}}
   		 	...
   		 	>
   		 		...
   		 		>
   		 			<KoubeiView actions={actions} statement={statement} city={city}/>
   		 		</TabNavigator.Item>
   		 		<TabNavigator.Item
   		 			key="friends"
   		 			title="朋友"
   		 			selected={this.state.selectedTab === "FriendsView"}
